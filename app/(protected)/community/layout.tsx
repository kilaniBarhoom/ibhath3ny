...
const CommunityLayout = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="flex">
      <aside className="fixed inset-y-0 left-right z-10 border-l border-border hidden lg:flex min-w-56 w-56 transition-all duration-300 ease-in-out overflow-y-auto">
        <SideNav />
      </aside>
