...
export const LampContainer = ({
  ...
  return (
    ...
    >
      <div className="relative w-full flex-1 scale-y-125 items-center justify-center isolate z-0 md:flex hidden">
        <motion.div
      ...
      <div className="relative flex md:hidden w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
      ...
      <div className="relative z-50 flex md:-translate-y-64 -translate-y-80 flex-col items-center py-5">
        {children}
      </div>
    </div>
  );
